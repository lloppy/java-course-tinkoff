...
public final class Task8 {
     ...
     */
    private static final String ZERO_ODD_OR_ONE_EVEN_PATTERN =
        "^(0[01]{2})*$|^(1[01]{2})*[01]$";

    /** Количество 0 кратно 3. */
    private static final String THREE_ZEROS_PATTERN = "^((1*01*){3})+$";
    ...
    public static boolean matchesZeroOddOrOneEvenPattern(
        final String inputString
    ) {
        return Pattern.matches(ZERO_ODD_OR_ONE_EVEN_PATTERN, inputString);
    }

    public static boolean matchesThreeZerosPattern(final String inputString) {
        return Pattern.matches(THREE_ZEROS_PATTERN, inputString);
    }

    public static boolean matchesExcept11Or111Pattern(
        final String inputString
    ) {
        return Pattern.matches(EXCEPT_11_OR_111_PATTERN, inputString);
    }

    public static boolean matchesNoConsecutiveOnesPattern(
        final String inputString
    ) {
